...
.NET Framework 3.5.1上で動作する、データベース(SQL SERVER 2017/2016/2014/2012/2008R2/2008/2005/2000)アプリケーションの開発者向けのMDI形式の補助ツールです。エンタープライズマネージャー/SQL Server Management Studioやクエリアナライザでは用意されていない機能を実現したり、使いにくい機能を補助する目的に作成されました(完全な置き換えは目標としていません)。
...
Copyright (C) 2004-2017　Y.N(godz)
