...
.NET Framework 2.0上で動作する、データベース(SQL SERVER 2008R2/2008/2005/2000)アプリケーションの開発者向けのMDI形式の補助ツールです。エンタープライズマネージャー/SQL Server Management Studioやクエリアナライザでは用意されていない機能を実現したり、使いにくい機能を補助する目的に作成されました(完全な置き換えは目標としていません)。
...
・	対象としているデータベースエンジンは SQL SERVER 2008R2/2008/2005/2000 
