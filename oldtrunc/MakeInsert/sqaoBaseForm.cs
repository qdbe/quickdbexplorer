...
{
	/// <summary>
	/// sqaoBaseForm の概要の説明です。
	/// </summary>
	public class sqaoBaseForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "sqaoBaseForm";
			this.Text = "sqaoBaseForm";
			this.Load += new System.EventHandler(this.sqaoBaseForm_Load);
			this.ResumeLayout(false);

		}
		#endregion

		private void sqaoBaseForm_Load(object sender, System.EventArgs e)
		{
			this.msgArea.Text = "";
		}
