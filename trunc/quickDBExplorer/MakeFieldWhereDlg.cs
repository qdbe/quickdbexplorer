...
namespace quickDBExplorer
{
	...
	public class MakeFieldWhereDlg : quickDBExplorer.quickDBExplorerBaseForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtAliasT1.Location = new System.Drawing.Point(136, 52);
			...
			this.txtAliasT2.Location = new System.Drawing.Point(344, 52);
			...
			this.txtWhereResult.Size = new System.Drawing.Size(552, 168);
			...
			this.btnCancel.Location = new System.Drawing.Point(656, 389);
			...
			this.rdoTable.Location = new System.Drawing.Point(16, 48);
			...
			// rdoEtc
			// 
			this.rdoEtc.Location = new System.Drawing.Point(16, 104);
			...
			this.groupBox1.Size = new System.Drawing.Size(584, 164);
			...
			// btnRef1
			// 
			this.btnRef1.Location = new System.Drawing.Point(136, 76);
			...
			this.cmbCondition.Items.AddRange(new object[] {
															  ...
															  "is null or != \'\'",
															  "is not null"});
			this.cmbCondition.Location = new System.Drawing.Point(344, 108);
			...
			// btnRef2
			// 
			this.btnRef2.Location = new System.Drawing.Point(344, 76);
			...
			this.txtAlias.Location = new System.Drawing.Point(136, 108);
			...
			// btnRef3
			// 
			this.btnRef3.Location = new System.Drawing.Point(136, 132);
			this.btnRef3.Name = "btnRef3";
			this.btnRef3.Size = new System.Drawing.Size(172, 20);
			this.btnRef3.TabIndex = 7;
		...
		private void reCreateSql()
		{
			...
			if( this.rdoTable.Checked == true )
			{
				...
				for(int i = 0; i < this.pFieldList.Count; i++ )
				{
					...
					sb.Append("(").Append(a1 + fname).Append(" = ").Append(a2 + fname).Append(")");
					if( this.chkPlace.Checked == true )
					{
						// 前につける場合改行のみでよい
						sb.Append("\r\n");
			...
			else
			{
				...
				for(int i = 0; i < this.pFieldList.Count; i++ )
				{
					...
					else
					{
						try
						{
							sb.Append("(").Append(strAlias).Append(fname).Append(" ").AppendFormat(this.cmbCondition.Text,strAlias+fname).Append(" )");
						}
						catch
						{
							// 書式不明の為、何もしない
