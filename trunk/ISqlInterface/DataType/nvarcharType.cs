...
{
    public class nvarcharType : IDataType
    {
        public string TypeName { get; private set; }

        private static IDataType typeInstance = null;
        ...
        public static IDataType Create()
        {
            ...
            {
                typeInstance = new nvarcharType();
            }
            return typeInstance;
        }

        public string Convert(string data, string addstr, string unichar, bool outNull, DBFieldInfo fieldInfo)
        {
