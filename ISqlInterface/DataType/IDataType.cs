...
namespace quickDBExplorer.DataType
{
    interface IDataType
    {
        ...
        bool TryCheckObject(object data, quickDBExplorer.DBFieldInfo fieldInfo, ref string errmsg);
        ...
        bool CheckValue(object val, quickDBExplorer.DBFieldInfo fieldInfo, out string errmsg);
    }
}
